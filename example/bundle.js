...
/***/ function(module, exports, __webpack_require__) {
	...
	var _copyToClipboard = __webpack_require__(155);
	...
	var CopyToClipboard = _react2['default'].createClass({
	  ...
	  onClick: function onClick() {
	    (0, _copyToClipboard2['default'])(this.props.text);
	  ...
	  render: function render() {
	    return _react2['default'].cloneElement(_react2['default'].Children.only(this.props.children), { onClick: this.onClick });
	  }
	});
